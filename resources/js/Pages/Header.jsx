...
const Header = () => {
    return (
        <>
            <header id="header_main" className="header_1 header_2 style2 js-header">
                            ...
                            <div id="site-header-inner">
                                <div className="wrap-box flex">
                                    ...
                                    <div className="question-form">
                                        <form action="home6.html#" method="get">
                                    ...
                                    <nav id="main-nav" className="main-nav">
                                        <ul id="menu-primary-menu" className="menu">
                                            ...
                                            <li className="menu-item">
                                                <a href="home6.html#">Explore</a>
                                            </li>
                                            <li className="menu-item">
                                                <a href="home6.html#">Activity</a>
                                            </li>
                                            <li className="menu-item">
                                                <a href="home6.html#">Community</a>
                                            </li>
                                            <li className="menu-item">
                                                <a href="home6.html#">Pages</a>
                                            </li>
                                            <li className="menu-item ">
                                    ...
                                    <div className="flat-search-btn flex">
                                        <div className="sc-btn-top mg-r-12" id="site-header">
                                            <a href="#" id="connectbtn" data-toggle="modal" data-target="#popup_bidf" className="sc-button header-slider style style-1 wallet fl-button pri-1"><span>Wallet connect
                                            </span></a>
                                        </div>
